      ...
      <Contact style={{ marginTop: '64px', gap: '64px' }}>
        ...
        <div>
          ...
          <p style={{ maxWidth: '768px' }}>
            ...
            voluptatibus, voluptates, quidem, quos voluptatem voluptatum consequatur quas doloremque
            magni quod doloribus. Rerum, voluptatum quia. Quia, voluptatem. Quam, voluptates.
            Quisquam voluptatibus, voluptates, quidem, quos voluptatem voluptatum consequatur quas
